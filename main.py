...
params = Parameters(dt=Time(1, 's'), gf_low=1, gf_high=1, last_stop_depth=5, gas_switch='stop')

# Create tanks
tanks = [Tank(size=15, gas=Gas(o2=21), start_pressure=200),
         Tank(size=10, gas=Gas(o2=32), start_pressure=200)]

# Create waypoints
waypoints = [Waypoint(45, 20)]  # , Waypoint(30, 2)]
